...
#Since my data goes from 2019 to 2021 let's just rename "Germany (until 1990 former territory of the FRG)" as Germany and Kosovo (under United Nations Security Council Resolution 1244/99) as Kosovo
    mutate(Countries=recode(Countries, `Germany (until 1990 former territory of the FRG)`= "Germany", `Kosovo (under United Nations Security Council Resolution 1244/99)` = "Kosovo"))%>%
